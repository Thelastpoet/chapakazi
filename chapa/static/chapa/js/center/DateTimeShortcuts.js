...
var DateTimeShortcuts = {
    ...
    center_media_prefix: '',
    init: function() {
        // Get center_media_prefix by grabbing it off the window object. It's
        // set in the center/base.html template, so if it's not there, someone's
        ...
        if (window.__center_media_prefix__ != undefined) {
            DateTimeShortcuts.center_media_prefix = window.__center_media_prefix__;
        } else {
            DateTimeShortcuts.center_media_prefix = '/missing-center-media-prefix/';
        }
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', DateTimeShortcuts.center_media_prefix + 'img/icon_clock.gif', 'alt', gettext('Clock'));
